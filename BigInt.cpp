...
BigInt BigInt::add2(const BigInt &b, int64_t start1, int64_t end1,
...
BigInt BigInt::subtract2(const BigInt &b, int64_t start1, int64_t end1,
                         int64_t start2, int64_t end2) const {
...
BigInt BigInt::long_mul(BigInt const &b, int64_t start1, int64_t end1,
...
BigInt BigInt::por_add(BigInt const &b, int64_t start1, int64_t end1,
                       int64_t start2, int64_t end2) const {
...
BigInt BigInt::por_sub(BigInt const &b, int64_t start1, int64_t end1,
                       int64_t start2, int64_t end2) const {
  int p = this->ab_comp2(b, start1, end1, start2, end2);
  if (p == 1) {
    if (this->IsSign(b, 1, 1))
...
BigInt BigInt::multiply(BigInt const &b, int64_t start1, int64_t end1,
                        int64_t start2, int64_t end2) {
  ...
  BigInt z1 = lh1.multiply(lh2, 0, lh1.size() - 1, 0,
...
int BigInt::ab_comp2(const BigInt &b, int64_t start1, int64_t end1,
                     int64_t start2, int64_t end2) const {
